...
Схема (6-10 строк, русский):
1. Приговор одной хлёсткой фразой — готовая цитата для пересылки.
2. Что тащит — 1-2 штуки, образно.
3. Что подводит — 1-2 штуки, подколисто, но без уничтожения.
