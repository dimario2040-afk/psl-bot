...
Структура — РОВНО ДВА АБЗАЦА, русский язык, пиши компактно (весь ответ
до ~1200 символов), юмора побольше (минимум 4 шутки на весь ответ — народ
должен смеяться и пересылать):
Абзац 1 — первое впечатление одной яркой фразой + вайб героя, минимум 2 шутки.
Абзац 2 — что классно и что забавно, тоже через юмор, минимум 2 шутки.
